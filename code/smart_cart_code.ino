...
void loop()
{
  ...
  if (Serial.available())
  {
    ...
    if (count == 12)
    {
      if ((strncmp(input, "0200685C1A2C", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "0200685C1A2C", 12) == 0) && (a == 0))
      {
        if(p1>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "0200689A8A7A", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "0200689A8A7A", 12) == 0) && (a == 0))
      {
         if(p2>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "0200697DB0A6", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "0200697DB0A6", 12) == 0) && (a==0))
      {
        if(p3>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "02006948381B", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "02006948381B", 12) == 0) && (a == 0))
      {
        if(p4>0)
        {
        lcd.clear();
      ...
      else if (strncmp(input, "020068FC66F0", 12) == 0)
      {
        lcd.clear();
        lcd.setCursor(0, 0);
